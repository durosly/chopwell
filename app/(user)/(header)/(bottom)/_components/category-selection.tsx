...
function CategorySelection() {
	return (
		<div className="carousel carousel-center items-start px-5 gap-4 w-screen mb-10">
			<Link href="/" className="carousel-item flex-col items-center">
				<div className="relative aspect-square w-[80px] rounded-full overflow-hidden">
					<Image fill src="https://img.daisyui.com/images/stock/photo-1559703248-dcaaec9fab78.webp" alt="Pizza" />
				</div>
