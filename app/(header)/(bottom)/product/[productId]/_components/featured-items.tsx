		...
		<div className="mb-5">
			...
			<div className="carousel carousel-center px-5 gap-2 py-3 w-screen">
				{Array(7)
					.fill(2)
					.map((_, i) => (
						<div key={i} className="carousel-item shadow-md border-[0.5px] flex-col rounded-2xl overflow-hidden w-[133px]">
							...
							<div className="p-2 space-y-1">
								<p>
									<span className="font-bold text-xs">NG 2,000</span> <span className="text-[10px]"> &bull;</span>{" "}
									<span className="text-[10px]">320 Cal</span>
								</p>

								<p className="text-[10px]">Medium burger French fries</p>

								<button className="btn btn-block btn-xs btn-accent">Add</button>
